...
import { Calendar, Clock, MapPin, BookOpen, Users, Bell, Download } from "lucide-react"
...
export function FacultyDashboard() {
  ...
  const weeklyStats = [
    { title: "Total Classes", value: "18", icon: BookOpen, color: "bg-blue-500" },
    { title: "Students", value: "156", icon: Users, color: "bg-green-500" },
    { title: "Subjects", value: "3", icon: Calendar, color: "bg-purple-500" },
    { title: "Hours/Week", value: "24", icon: Clock, color: "bg-orange-500" },
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-2">Good morning, Dr. Johnson</h2>
              ...
              {todaySchedule.map((class_, index) => (
                <div key={index} className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground">Batch: {class_.batch}</div>
                  </div>
                  <div className="flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader className="pb-3">
              <div className="flex items-center">
                ...
                <div>
                  <CardTitle className="text-base">View Full Schedule</CardTitle>
                </div>
              </div>
            </CardHeader>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            ...
            <CardContent className="pt-0">
              <CardDescription>Update your subject preferences</CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            ...
            <CardContent className="pt-0">
              <CardDescription>Submit leave requests and availability</CardDescription>
            </CardContent>
          </Card>
        </div>
      </div>
